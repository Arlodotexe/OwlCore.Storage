...
/// <summary>
/// A storage property representing the last modified timestamp as a <see cref="DateTimeOffset"/>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Not all implementations support offset data—<see cref="DateTime"/> via <see cref="ILastModifiedAtProperty"/> is the least common denominator.
...
/// </para>
/// </remarks>
public interface ILastModifiedAtOffsetProperty : IStorageProperty<DateTimeOffset?>
{
}

...
/// <summary>
/// Indicates that the storage item supports retrieving the last accessed timestamp as a <see cref="DateTime"/>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// When timezone offset information is required and the implementation can provide it, use <see cref="ILastAccessedAtOffset"/> instead.
/// </para>
/// </remarks>
public interface ILastAccessedAt
{
    /// <summary>
    /// Asynchronously retrieves the last accessed timestamp of the storage item.
    /// </summary>
    /// <param name="cancellationToken">A token that can be used to cancel the ongoing operation.</param>
    /// <returns>A task containing the storage property with the last accessed timestamp, or <c>null</c> if unavailable or unset.</returns>
    Task<IStorageProperty<DateTime?>> GetLastAccessedAtAsync(CancellationToken cancellationToken);
}

...
/// <summary>
/// A storage property representing the last accessed timestamp as a <see cref="DateTimeOffset"/>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Not all implementations support offset data—<see cref="DateTime"/> via <see cref="ILastAccessedAtProperty"/> is the least common denominator.
...
/// </para>
/// </remarks>
public interface ILastAccessedAtOffsetProperty : IStorageProperty<DateTimeOffset?>
{
}

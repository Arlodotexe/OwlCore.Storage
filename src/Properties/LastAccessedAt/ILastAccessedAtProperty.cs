...
/// <summary>
/// A storage property representing the last accessed timestamp as a <see cref="DateTime"/>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// When timezone offset information is required and the implementation can provide it, use <see cref="ILastAccessedAtOffsetProperty"/> instead.
/// </para>
/// </remarks>
public interface ILastAccessedAtProperty : IStorageProperty<DateTime?>
{
}
